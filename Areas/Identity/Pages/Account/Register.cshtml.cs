...
namespace Spotifo.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new SpotifoUser { 
                    Nombre_user = Input.Nombre_user,
                    Apellido_user = Input.Apellido_user,
                    Biografia_user = Input.Biografia_user,
